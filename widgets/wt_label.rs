 ...
 */
unsafe extern "C" fn wt_label_prepare(mut w: *mut stfl_widget,
                                      mut f: *mut stfl_form) {
...
unsafe extern "C" fn wt_label_draw(mut w: *mut stfl_widget,
                                   mut f: *mut stfl_form,
                                   mut win: *mut WINDOW) {
            ...
            let mut init =
                stfl_widget_type{name:
                                     (*::std::mem::transmute::<&[u8; 24],
                                                               &[libc::c_int; 6]>(b"l\x00\x00\x00a\x00\x00\x00b\x00\x00\x00e\x00\x00\x00l\x00\x00\x00\x00\x00\x00\x00")).as_ptr()
                                         as *mut wchar_t,
                                 f_init: None,
                                 f_done: None,
                                 f_enter: None,
